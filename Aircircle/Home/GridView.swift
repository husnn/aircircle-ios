        ...
        GeometryReader { proxy in
            ...
            ZStack() {
                ...
                ZStack {
                    ...
                    Circle()
                        .strokeBorder(isRecording ? Color.red.opacity(0.7) : Color.aircircleOlive, lineWidth: 4)
                    //                        .strokeBorder(Color.random(), lineWidth: 4)
                        .background(Circle().fill(isRecording ? Color.red.opacity(0.15) : Color.aircircleGreen))
