...
enum JonoAuthPB_Method: SwiftProtobuf.Enum {
...
extension JonoAuthPB_Method: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [JonoAuthPB_Method] = [
    .unspecified,
    .email,
    .phone,
    .apple,
...
enum JonoAuthPB_SignupStep: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case unspecified // = 0
  case initial // = 1
  case success // = 2
...
extension JonoAuthPB_SignupStep: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [JonoAuthPB_SignupStep] = [
    .unspecified,
    .initial,
    .success,
  ]
...
enum JonoAuthPB_LoginStep: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case unspecified // = 0
  case initial // = 1
  case submitOtp // = 2
...
extension JonoAuthPB_LoginStep: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [JonoAuthPB_LoginStep] = [
    .unspecified,
    .initial,
    .submitOtp,
    .success,
...
enum JonoAuthPB_ResetPasswordStep: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case unspecified // = 0
  case initial // = 1
  case submitOtp // = 2
...
extension JonoAuthPB_ResetPasswordStep: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [JonoAuthPB_ResetPasswordStep] = [
    .unspecified,
    .initial,
    .submitOtp,
    .resendOtp,
...
struct JonoAuthPB_SignupRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var step: JonoAuthPB_SignupStep = .unspecified

  var method: JonoAuthPB_Method = .unspecified

  var password: String = String()

  var identifier: JonoAuthPB_SignupRequest.OneOf_Identifier? = nil
  ...
  #if !swift(>=4.1)
    static func ==(lhs: JonoAuthPB_SignupRequest.OneOf_Identifier, rhs: JonoAuthPB_SignupRequest.OneOf_Identifier) -> Bool {
...
struct JonoAuthPB_SignupResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var session: JonoAuthPB_Session {
    get {return _session ?? JonoAuthPB_Session()}
  ...
  fileprivate var _session: JonoAuthPB_Session? = nil
}

struct JonoAuthPB_LoginRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var step: JonoAuthPB_LoginStep = .unspecified
  ...
  var identifier: JonoAuthPB_LoginRequest.OneOf_Identifier? = nil
  ...
  #if !swift(>=4.1)
    static func ==(lhs: JonoAuthPB_LoginRequest.OneOf_Identifier, rhs: JonoAuthPB_LoginRequest.OneOf_Identifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct JonoAuthPB_LoginResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct JonoAuthPB_ResetPasswordRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var step: JonoAuthPB_ResetPasswordStep = .unspecified
  ...
  var identifier: JonoAuthPB_ResetPasswordRequest.OneOf_Identifier? = nil
  ...
  #if !swift(>=4.1)
    static func ==(lhs: JonoAuthPB_ResetPasswordRequest.OneOf_Identifier, rhs: JonoAuthPB_ResetPasswordRequest.OneOf_Identifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct JonoAuthPB_ResetPasswordResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension JonoAuthPB_Method: @unchecked Sendable {}
extension JonoAuthPB_SignupStep: @unchecked Sendable {}
extension JonoAuthPB_LoginStep: @unchecked Sendable {}
extension JonoAuthPB_ResetPasswordStep: @unchecked Sendable {}
extension JonoAuthPB_Session: @unchecked Sendable {}
extension JonoAuthPB_SignupRequest: @unchecked Sendable {}
extension JonoAuthPB_SignupRequest.OneOf_Identifier: @unchecked Sendable {}
extension JonoAuthPB_SignupResponse: @unchecked Sendable {}
extension JonoAuthPB_LoginRequest: @unchecked Sendable {}
extension JonoAuthPB_LoginRequest.OneOf_Identifier: @unchecked Sendable {}
extension JonoAuthPB_LoginResponse: @unchecked Sendable {}
extension JonoAuthPB_ResetPasswordRequest: @unchecked Sendable {}
extension JonoAuthPB_ResetPasswordRequest.OneOf_Identifier: @unchecked Sendable {}
extension JonoAuthPB_ResetPasswordResponse: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "io.jono.auth"

extension JonoAuthPB_Method: SwiftProtobuf._ProtoNameProviding {
...
extension JonoAuthPB_SignupStep: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension JonoAuthPB_LoginStep: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension JonoAuthPB_ResetPasswordStep: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension JonoAuthPB_Session: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_Session, rhs: JonoAuthPB_Session) -> Bool {
...
extension JonoAuthPB_SignupRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_SignupRequest, rhs: JonoAuthPB_SignupRequest) -> Bool {
...
extension JonoAuthPB_SignupResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_SignupResponse, rhs: JonoAuthPB_SignupResponse) -> Bool {
    if lhs.step != rhs.step {return false}
    if lhs.method != rhs.method {return false}
...
extension JonoAuthPB_LoginRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_LoginRequest, rhs: JonoAuthPB_LoginRequest) -> Bool {
    if lhs.step != rhs.step {return false}
...
extension JonoAuthPB_LoginResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_LoginResponse, rhs: JonoAuthPB_LoginResponse) -> Bool {
    if lhs.step != rhs.step {return false}
    if lhs.grantID != rhs.grantID {return false}
    if lhs.method != rhs.method {return false}
    if lhs._session != rhs._session {return false}
...
extension JonoAuthPB_ResetPasswordRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_ResetPasswordRequest, rhs: JonoAuthPB_ResetPasswordRequest) -> Bool {
    if lhs.step != rhs.step {return false}
    if lhs.userType != rhs.userType {return false}
    if lhs.method != rhs.method {return false}
    if lhs.password != rhs.password {return false}
...
extension JonoAuthPB_ResetPasswordResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: JonoAuthPB_ResetPasswordResponse, rhs: JonoAuthPB_ResetPasswordResponse) -> Bool {
    if lhs.step != rhs.step {return false}
    if lhs.grantID != rhs.grantID {return false}
    if lhs.nextOtpSend != rhs.nextOtpSend {return false}
    if lhs.method != rhs.method {return false}
